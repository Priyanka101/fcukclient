...
/*Code Commented for Updating stock status Start*/
    //$connection->query($sql);
	//$connection->query($sql2);
/*Code Commented for Updating stock status End*/                       

/*Code Updated for Updating stock status Start*/
		
		$parentIds = Mage::getResourceSingleton('catalog/product_type_configurable')->getParentIdsByChild($productId);
		Mage::getModel('catalog/product_status')->updateProductStatus($productId, 1, Mage_Catalog_Model_Product_Status::STATUS_ENABLED);
		Mage::getModel('catalog/product_status')->updateProductStatus($parentIds[0], 1, Mage_Catalog_Model_Product_Status::STATUS_ENABLED);
...
/*Code Updated for Updating stock status End*/                       

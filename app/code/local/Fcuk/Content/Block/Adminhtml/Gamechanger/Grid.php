...
class Fcuk_Content_Block_Adminhtml_Gamechanger_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
		...
		protected function _prepareColumns()
		{
				...
				'index' => 'slideno',
				'type' => 'options',
				'options'=>Fcuk_Content_Block_Adminhtml_Gamechanger_Grid::getOptionArray1(),				
				));
				...
				'index' => 'type',
				'type' => 'options',
				'options'=>Fcuk_Content_Block_Adminhtml_Gamechanger_Grid::getOptionArray2(),				
				));
...
/*				$this->addColumn("name1", array(
				...
				"index" => "image1",
				"renderer" =>"Fcuk_Content_Block_Adminhtml_Renderer_Image",
				));
		...
		{
            $data_array=array();
			foreach(Fcuk_Content_Block_Adminhtml_Gamechanger_Grid::getOptionArray1() as $k=>$v){
		...
		{
            $data_array=array();
			foreach(Fcuk_Content_Block_Adminhtml_Gamechanger_Grid::getOptionArray2() as $k=>$v){
               $data_array[]=array('value'=>$k,'label'=>$v);		
			}
            return($data_array);

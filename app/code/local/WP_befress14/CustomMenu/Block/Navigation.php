...
class WP_CustomMenu_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawCustomMenuItem($category, $level = 0, $last = false)
    {
        ...
        if ($drawPopup) {
            ...
            $html[] = '<div id="popup' . $id . '" class="wp-custom-menu-popup " onmouseout="wpHideMenuPopup(this, event, \'popup' . $id . '\', \'menu' . $id . '\')" onmouseover="wpPopupOver(this, event, \'popup' . $id . '\', \'menu' . $id . '\')" style="visibility:hidden">';
            $html[] = '<div class="main_category_block">';
            // --- draw Sub Categories ---
            ...
            if ($blockHtml) {
                $html[] = '<div class="right-slider-wrapper">';
                $html[] = '<!--div class="slider_title">This week FC loves</div-->';
                $html[] = '<div id="' . $blockId . '" class="block2 bxslider-menu">';
                $html[] = $blockHtml;
                $html[] = '</div>';
                $html[] = '</div>';
            }

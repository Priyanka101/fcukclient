...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if($text=='1'){
             ...
             $collection->getSelect()->joinLeft('sales_flat_shipment_track', 'main_table.entity_id = sales_flat_shipment_track.order_id', 'GROUP_CONCAT(sales_flat_shipment_track.title SEPARATOR ",") as shipping_carrier');
                  $collection->getSelect()->group('main_table.entity_id');
                /* Query to fetch shipping carrier from sales_flat_shipment_track */ 
              //$collection->getSelect()->joinRight('sales_flat_shipment_track', 'main_table.entity_id = sales_flat_shipment_track.order_id', 'GROUP_CONCAT(sales_flat_shipment_track.title SEPARATOR ",") as shipping_carrier');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('real_order_id', array(
		 ...
		 $this->addColumn('shipping_carrier', array(
            ...
            'width' => '80px',
            'type'  => 'text',
			'filter_index' => 'sales_flat_shipment_track.title',

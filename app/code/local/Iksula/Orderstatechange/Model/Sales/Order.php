...
class Iksula_Orderstatechange_Model_Sales_Order extends Mage_Sales_Model_Order
{
    const ENTITY                                = 'order';
    ...
    const STATE_PENDING_STOCK   = 'pending_stock';
    const STATE_SEND_TO_SETTING   = 'send_to_setting';
    const STATE_SEND_TO_CASTING   = 'send_to_casting';
    const UNPROCESSED_REFUND   = 'unprocessed_refund';
    const SHIPPED_REFUND   = 'shipped_refund';

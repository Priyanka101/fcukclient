							...
							<td colspan="2">
								<table>
									<tr>
										...
										<td style=" background-color: #ccc;text-align:right;">27740861483V</td>
										<td style="width:50px;">&nbsp;</td>
										<td style=" background-color: #ccc; width:285px;"><strong>Ship To:</strong></td>
									</tr>
									<tr>
										<td style=" background-color: #ccc;">CST No</td>
										<td style=" background-color: #ccc;text-align:right;">27740861483C</td>
										<td style="width:50px;">&nbsp;</td>
									...
									<tr style="text-align:center;">
										...
										foreach ($invoices->getAllItems() as $item){
										  ...
										  $product = Mage::getModel('catalog/product')->load($itemArr['product_id']);
										   ...
										   $qty = $itemArr['qty'];
										   $base_price = $itemArr['price'];//indi price
										   $discountAmount =$itemArr['discount_amount'];
										...
										//   $vat_tax = $attr->getData('tax_amount'); 

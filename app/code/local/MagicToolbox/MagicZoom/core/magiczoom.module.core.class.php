...
if(!defined('MagicZoomModuleCoreClassLoaded')) {
    ...
    class MagicZoomModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Magento module version v4.7.21 [v1.3.18:v4.5.10] -->';
        ...
        function getMainTemplate($params) {
            ...
            return "<a{$link} class=\"MagicZoom\"{$title} id=\"MagicZoomImage{$id}\" href=\"{$img}\" {$rel}><img itemprop=\"image\"{$width}{$height} src=\"{$thumb}\" alt=\"{$alt}\" /></a><br />{$message}";
        }

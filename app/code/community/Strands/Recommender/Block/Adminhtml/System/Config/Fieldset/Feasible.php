    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    {    	
    	...
    	if ($id == 'recommender_catalog_cron_feasible') {
...
';
    	...
    	} elseif ($id == 'recommender_catalog_feed_feasible') {
...
';
    	...
    	} elseif ($id == 'recommender_catalog_strands_catalog_time') {
...
';    	
    	} elseif ($id == 'recommender_cron_help') {
...
';
		} elseif ($id == 'recommender_catalog_cron_explanation') {
...
';		
    	} elseif ($id == 'recommender_catalog_feed_explanation') {
...
'; 
    	} elseif ($id == 'recommender_catalog_manual_explanation') {
...
'; 
    	} elseif ($id == 'recommender_account_new') {

...
class KM_Shippingcarriers_Model_Bluedart extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {
    ...
    public function getTracking($tracking_number) {
        ...
        $path = $this->getConfigData('gateway_url');

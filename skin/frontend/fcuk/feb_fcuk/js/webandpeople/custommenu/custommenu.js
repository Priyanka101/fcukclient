    ...
    if (!objMenu.hasClassName('active')) {
        //wpCustommenuTimerShow[popupId] = setTimeout(function() {
            ...
            if (typeof jQuery == 'undefined') {
                ...
                //console.log("two"+parseInt(jQuery('#' + popupId).height()+ jQuery('.menu').height()));
                jQuery('#' + popupId).stop(true, true).show();
                jQuery('#' + popupId).show();

                jQuery('.main_category_block').css("visibility","visible");           
                jQuery('.main-navigation').stop().animate({'height':parseInt(jQuery('#' + popupId).height()+ jQuery('.menu').height())+'px'}, 1);
            }
                ...
                if (objMenu.hasClassName('active')) {
                    //wpCustommenuTimerHide[popupId] = setTimeout(function() {
                        ...
                        if (typeof jQuery == 'undefined') {
                            ...
                            jQuery('#' + popupId).hide();
                            jQuery('.main-navigation').stop().animate({'height':'37px'}, 1, function(){});
                        }

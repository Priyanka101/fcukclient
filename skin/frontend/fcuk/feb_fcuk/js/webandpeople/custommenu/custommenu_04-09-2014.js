    ...
    if (!objMenu.hasClassName('active')) {
        wpCustommenuTimerShow[popupId] = setTimeout(function() {
            ...
            if (typeof jQuery == 'undefined') {
                ...
                jQuery('#' + popupId).show();
                console.log(jQuery('#' + popupId).height());  
                jQuery('.main_category_block').css("visibility","visible");              
                jQuery('.main-navigation').stop().animate({'height':parseInt(jQuery('#' + popupId).height()+ jQuery('.menu').height())+'px'});
            }
                ...
                if (objMenu.hasClassName('active')) {
                    wpCustommenuTimerHide[popupId] = setTimeout(function() {
                        ...
                        if (typeof jQuery == 'undefined') {
                            ...
                            jQuery('.main-navigation').stop().animate({'height':'37px'}, 'slow', function(){
                            });
                        }
